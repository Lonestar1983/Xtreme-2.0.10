...
function modadmin_edit_module($module) 
{
   ...
   if(substr($module['title'],0,3) != '~l~') 
   {
      ...
      // echo '    <td class="row1" style="width: 50%;">'.select_box('blocks', $module['blocks'], array("0"=>_NONE, "1"=>_LEFT, "2"=>_RIGHT, "3"=>_BOTH)).'</td>';
      echo '    <td class="row1" style="width: 50%;">';
...
function modadmin_block () {
    ...
    if(is_array($inactive)) 
    {
        foreach ($inactive as $element) 
        {
            ...
            // $custom_title .= "&nbsp;&nbsp;<a href=\"".$admin_file.".php?op=modules&amp;edit=".$element['mid']."\">".get_evo_icon('evo-sprite edit', $admlang['modblock']['modedit'])."</a>";
    ...
    if(is_array($modadmin_module_cats)) 
    {
        ...
        foreach ($modadmin_module_cats as $cat) 
        {
            ...
            {
                // $custom_title = (substr($row['title'],0,3) == '~l~') ? "<span style=\"color: blue;\">".substr($row['title'],3)."</span>&nbsp;&nbsp;<a href=\"".$admin_file.".php?op=modules&amp;delete=".$row['mid']."\">".get_evo_icon('evo-sprite delete')."</a>" : $row['custom_title'];
                // $custom_title .= "&nbsp;&nbsp;<a href=\"".$admin_file.".php?op=modules&amp;edit=".$row['mid']."\">".get_evo_icon('evo-sprite edit', $admlang['modblock']['modedit'])."</a>";
    ...
    // echo "<table width=\"50%\" border=\"0\" cellpadding=\"4\" cellspacing=\"1\" class=\"forumline acenter\">\n";
    // echo "<tr>\n<td class=\"row1\">\n<br />";
    // echo $admlang['modblock']['image_note']."\n<br /><br />";
    // echo "<form action=\"".$admin_file.".php?op=modules&amp;area=block\" method=\"post\">\n";
    // echo $admlang['global']['title'].":&nbsp;<input type=\"text\" name=\"cat\" id=\"cat\" value=\"\" size=\"30\" maxlength=\"30\" />\n<br />";
    // echo $admlang['modblock']['image'].":&nbsp;<input type=\"text\" name=\"catimage\" id=\"catimage\" value=\"\" size=\"30\" maxlength=\"50\" />\n<br />";
    // echo "<input type=\"submit\" value=\"".$admlang['global']['submit']."\" />";
    // echo "</form>\n";
    // echo "</td></tr>";
    ...
    // echo "<form action=\"".$admin_file.".php?op=modules&amp;area=block\" method=\"post\">\n";
    // echo $admlang['modblock']['link_title'].":&nbsp;<input type=\"text\" name=\"linktitle\" id=\"linktitle\" value=\"\" size=\"30\" maxlength=\"30\" />\n<br />";
    // echo $admlang['global']['url'].":&nbsp;<input type=\"text\" name=\"link\" id=\"link\" value=\"\" size=\"30\" maxlength=\"100\" />\n<br />";
    // echo "<input type=\"submit\" value=\"".$admlang['global']['submit']."\" />";
    // echo "</form>\n";
    // echo "</td></tr>";
    // echo "</table>\n";

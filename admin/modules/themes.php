...
function update_theme( $post ) {
	...
	$sql[] = "UPDATE " . _THEMES_TABLE . " SET custom_name = '" . $post['custom_name'] . "' WHERE theme_name = '" . $post['theme_name'] . "'";
	$sql[] = "UPDATE " . _THEMES_TABLE . " SET active = '" . $post['active'] . "' WHERE theme_name = '" . $post['theme_name'] . "'";
	$sql[] = "UPDATE " . _THEMES_TABLE . " SET permissions = '" . $post['permissions'] . "' WHERE theme_name = '" . $post['theme_name'] . "'";
	$sql[] = "UPDATE " . _THEMES_TABLE . " SET theme_info = '" . $theme_info . "' WHERE theme_name = '" . $post['theme_name'] . "'";
	...
	cache_delete( $post['theme_name'], 'themes' );

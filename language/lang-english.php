...
define_once( '_EMPTY_MESSAGE','You must enter a message first' );

// new common language defines.
define_once( '_S_ADMIN_PANEL','Admin Panel' );
define_once( '_L_ADMIN_PANEL','Administration' );
define_once( '_EDIT_PROFILE','Edit Profile' );
define_once( '_YOUHAVE_X_MSGS','You Have %s New Private Messages' );
define_once( '_WATCH_YOUTUBE','Watch this video on YouTube' );
define_once( "_POSTEDBY", "Posted by" );
define_once( "_ON", "on" );

define_once( "_CHARSET", "UTF-8" );
define_once( "_LANG_DIRECTION", "ltr" );
...
define_once( '_ANONYMOUS', 'Anonymous' );
...
define_once( '_MVIEWGROUP', 'View: Groups Only' );
define_once( '_MVIEWALL', 'View: All Visitors' );
define_once( '_MODULESGROUP', 'We are Sorry but this section of our site is for <i>Group Members</i> of the following groups only.' );

define_once( "_HOUR", "Hour" );
define_once( "_HOURS", "Hours" );

define_once( "_MODULEDOESNOTEXIST", "Sorry... but this module does not exist!" );
...
define_once( "_BLOCKPROBLEM", "There is a problem right now with this block." );
define_once( "_BLOCKPROBLEM2", "There isn't content right now for this block." );
...
define_once( "_NEWSLETTERBLOCKSUBSCRIBED", "You are subscribed to the newsletter" );
define_once( "_NEWSLETTERBLOCKREGISTER", "You must register to receive the newsletter" );
define_once( "_NEWSLETTERBLOCKREGISTERNOW", "Click to register" );
define_once( "_NEWSLETTERBLOCKNOTSUBSCRIBED", "You are not subscribed to the newsletter" );
define_once( "_NEWSLETTERBLOCKSUBSCRIBE", "Click to subscribe" );
define_once( "_NEWSLETTERBLOCKUNSUBSCRIBE", "Click to unsubscribe" );

define_once( "_PASTARTICLES", "Past Articles" );
define_once( "_OLDERARTICLES", "Older Articles" );

define_once( '_DATESTRING','%A, %B %d, %Y (%H:%M:%S)' );
define_once( '_DATESTRING2','%A, %B %d' );
define_once( '_DATESTRING3','%d-%b-%Y' );
define_once( '_DATESTRING4','%1$s, %2$s %3$s' );
...
//define_once( '_PAGEFOOTER','This page was generated in %1$s seconds with %2$s DB Queries in %3$s seconds' );
...
define_once( "_NOTSUB", "You are not a subscriber of" );
define_once( "_NOTSUBUSR", "Not a subscriber of" );
...
define_once( "_LASTVISIT", "Last visit:" );
define_once( "_LASTNA", "N/A" );

define_once( "_CZ_SECURITYCODE", "Security Code: " );
define_once( "_CZ_TYPESECCODE", "Type Security Code Here: " );
define_once( "_ADMIN_BLOCK_DENIED", "You are not allowed to view this block" );
define_once( "_MODULEERROR", "There was a module error" );
define_once ("_TOPICNCB", "Topic" );
define_once ("_ARTICLENCB", "Title and Date" );
define_once ("_READMORENCB", "Read More" );
define_once ("_OPTIONSNCB", "Options" );
define_once ("_ADMINNCB", "Admin" );

...
$submit         = ( isset( $_POST['post'] ) ) ?: false;
$submit_search  = ( isset( $_POST['usersubmit'] ) ) ?: false;
$submit_msgdays = ( isset( $_POST['submit_msgdays'] ) ) ?: false;
$cancel         = ( isset( $_POST['cancel'] ) ) ?: false;
$preview        = ( isset( $_POST['preview'] ) ) ?: false;
$confirm        = ( isset( $_POST['confirm'] ) ) ?: false;
$delete         = ( isset( $_POST['delete'] ) ) ?: false;
$delete_all     = ( isset( $_POST['deleteall'] ) ) ?: false;
$save           = ( isset( $_POST['save'] ) ) ?: false;
$sid            = ( isset( $_POST['sid'] ) ) ? $_POST['sid'] : false;
 ...
 ******************************************************/
				...
				if ( $mode != 'edit' ) {
					...
					if ( $to_userdata['user_notify_pm'] && ! empty( $to_userdata['user_email'] ) && $to_userdata['user_active'] ) {
						...
						$content = str_replace(
							'{USERNAME}',
							$to_userdata['username'],
							$lang['private_message_notify']
						);

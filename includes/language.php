...
if ( $multilingual ) {
	...
	} elseif ( isset( $_POST['newlang'] ) && is_lang( $_POST['newlang'] ) ) {
	...
	$cookiename       = get_board_option( 'cookie_name' );
	$cookiepath       = get_board_option( 'cookie_path' );
	$cookiedomain     = get_board_option( 'cookie_domain' );
	$cookiesecure     = get_board_option( 'cookie_secure' );
